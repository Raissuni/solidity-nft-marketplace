...
contract NFTMarketplaceTest is Test { 
    ...
    function testShuoldRevertIfPriceIsZero () public {
        vm.startPrank(user);
    ...
    function testShuoldRevertIfNotOwner () public {
        vm.startPrank(user);
        ...
        vm.expectRevert("You are not owner of the nft");
    ...
    function testListShouldRevertIfNotOwner() public {
        ...
        vm.expectRevert("You are not the listin ownew");
